...
const IDENTITY_RULES: TermRule[] = [
  ...
  { keys: ["chow mein", "lo mein", "炒麵", "撈麵"], canonicalName: "fried-noodles", category: "mixed", qualifiers: ["composite"] },
  ...
  { keys: ["vegetables", "vegetable", "蔬菜", "菜"], canonicalName: "vegetables", category: "vegetable" },
